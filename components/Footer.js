    ...
    return (
        <footer className="pt-24 pb-6">
            <Container className="flex flex-col lg:flex-row lg:justify-between items-center gap-10 lg:gap-20">
                <div className="w-full flex flex-col md:flex-row lg:flex-col xl:flex-row justify-between items-center md:items-stretch lg:items-center xl:items-stretch gap-4">
                    <Button href="/contact"
                            theme="primary"
                            size="custom"
                            textSize="big"
                    ...
                    <div className="flex-1 w-full">
                        <form action="" className="w-full flex items-stretch h-full">
                            <Input type="email" placeholder="Your e-mail" className="flex-1"/>
                            <Button type="submit"
                                    theme="secondary"
                                    size="small"
                                    textSize="tiny"
                ...
                <div className="flex flex-wrap lg:flex-nowrap justify-center sm:justify-start items-center gap-y-4 gap-x-10 md:gap-4 xl:gap-10">
